...
export const createGroup = (formValues) => (dispatch) => {
  axios
    ...
    .then((response) => {
      history.push('/groups');
      dispatch({ type: CREATE_GROUP, payload: response.data.data });
      dispatch(getUser());
    })
    .catch((err) => {
      const { response } = err;
...
export const editGroup = (groupId, formValues) => (dispatch) => {
  axios
    ...
    .then((response) => {
      history.push('/groups');
      dispatch({ type: EDIT_GROUP, payload: response.data.data });
    })
    .catch((err) => {
      const { response } = err;
      if (response.status === 401) {
...
export const editGroupState = (groupId, state) => (dispatch) => {
  axios
    ...
    .then((response) => {
      ...
      dispatch({ type: EDIT_GROUP_STATE, payload: response.data.data });
    })
    .catch((err) => {
      const { response } = err;
      if (response.status === 401) {
...
export const editGroupMemberState = (groupId, memberId, state) => (
  ...
  axios
    ...
    .then((response) => {
      ...
      dispatch({ type: EDIT_GROUP_MEMBER_STATE, payload: response.data.data });
    })
    .catch((err) => {
      const { response } = err;
      if (response.status === 401) {
...
export const deleteGroupMember = (groupId, memberId) => (dispatch) => {
  axios
    ...
    .then((response) => {
      history.push(`/groups/${groupId}/members`);
      dispatch({ type: DELETE_GROUP_MEMBER, payload: response.data.data });
    })
    .catch((err) => {
      const { response } = err;
      if (response.status === 401) {
...
export const requestGroupJoin = (groupId) => (dispatch) => {
  axios
    ...
    .then((response) => {
      ...
      dispatch({ type: CREATE_GROUP_JOIN, payload: response.data.data });
      dispatch(getUser());
    })
    .catch((err) => {
      const { response } = err;
...
export const requestGroupLeave = (groupId) => (dispatch) => {
  axios
    ...
    .then((response) => {
      history.push(`/groups/${groupId}`);
      dispatch({ type: EDIT_GROUP_LEAVE, payload: response.data.data });
    })
    .catch((err) => {
      const { response } = err;
      if (response.status === 401) {
