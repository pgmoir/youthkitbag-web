        ...
        <div className="container">
          <div className="row m-5 p-5 bg-light">
            <div className="col-12">
              ...
              <p>
                Moir Consultancy Limited, 10 Forest Way, Woodford Green
                <br />
                Essex IG8 0QE
              </p>
              <p>
                <strong>Owner contact email:</strong>
                <a href="mailto:admin@youthkitbag.com">admin@youthkitbag.com</a>
              </p>
              ...
              <p>
                ...
                email address; first name; last name; phone number; company
                name; unique device identifiers for advertising (Google
                Advertiser ID or IDFA, for example); Data communicated while
                using the service.
              </p>
              <p>
              ...
              <p>
                ...
                Website or by the owners of third-party services used by this
                Website serves the purpose of providing the Service required by
                the User, in addition to any other purposes described in the
              ...
              <p>
                ...
                that they have the third party&apos;s consent to provide the
                Data to the Owner.
              </p>
              ...
              <p>
                ...
                types of persons in charge, involved with the operation of this
              ...
              <ul>
                <li>
                  ...
                  such processing (“opt-out”), without having to rely on consent
                  or any other of the following legal bases. This, however, does
                  not apply, whenever the processing of Personal Data is subject
              ...
              <p>
                ...
                in any other places where the parties involved in the processing
                are located.
              </p>
              <p>
                ...
                of such transferred Data, Users can check the section containing
              ...
              <p>
                ...
                international organization governed by public international law
                or set up by two or more countries, such as the UN, and about
                the security measures taken by the Owner to safeguard their
                Data.
              </p>
              <p>
              ...
              <p>
                ...
                Analytics, Managing contacts and sending messages, Contacting
                the User, Interaction with data collection platforms and other
                third parties, Remarketing and behavioral targeting, Tag
                Management and User database management.
              </p>
              <p>
                Users can find further detailed information about such purposes
                of processing and about the specific Personal Data used for each
              ...
              <p>
                ...
                Ireland Limited (“Google”). Google utilizes the Data collected
                to track and examine the use of this Website, to prepare reports
              ...
              <p>
                Place of processing: Ireland – Privacy Policy – Opt Out. Privacy
                Shield participant.
              </p>
              ...
              <p>
                ...
                advertising network with actions performed on this Website.
              </p>
              <p>Personal Data collected: Cookies; Usage Data.</p>
              <p>
                Place of processing: Ireland – Privacy Policy. Privacy Shield
                participant.
              </p>
              <h4>
              ...
              <p>
                ...
                Features activated, which collects additional information from
                the DoubleClick cookie (web activity) and from device
                advertising IDs (app activity). It allows the Owner to analyze
                specific behavior and interests Data (traffic Data and
                Users&apos; ads interaction Data) and, if enabled, demographic
              ...
              <p>
                ...
                Advertising Reporting feature that makes available demographic
                and interests Data inside Google Analytics for this Website
              ...
              <h4>LinkedIn conversion tracking (LinkedIn Corporation)</h4>
              <p>
                LinkedIn conversion tracking is an analytics service provided by
                LinkedIn Corporation that connects data from the LinkedIn
                advertising network with actions performed on this Website.
              </p>
              <p>Personal Data collected: Cookies; Usage Data.</p>
              <p>
                Place of processing: United States – Privacy Policy. Privacy
                Shield participant.
              </p>
              ...
              <p>
                Personal Data collected: company name; email address; first
              ...
              <h4>Phone contact (this Website)</h4>
              <p>
                Users that provided their phone number might be contacted for
                commercial or promotional purposes related to this Website, as
              ...
              <p>
                ...
                collection platforms or other services directly from the pages
                of this Website for the purpose of saving and reusing data. If
                one of these services is installed, it may collect browsing and
                Usage Data in the pages where it is installed, even if the Users
                do not actively use the service.
              </p>
              <h4>Mailchimp widget (The Rocket Science Group LLC)</h4>
              <p>
                The Mailchimp widget is a service for interacting with the
                Mailchimp email address management and message sending service
                provided by The Rocket Science Group LLC.
              </p>
              <p>
                Personal Data collected: Cookies; email address; first name;
              ...
              <p>
                ...
                email contacts, phone contacts or any other contact information
                to communicate with the User. These services may also collect
                data concerning the date and time when the message was viewed by
                the User, as well as when the User interacted with it, such as
              ...
              <p>
                This type of service allows this Website and its partners to
              ...
              <p>
                ...
                manage the remarketing and behavioral targeting activity. Some
                services offer a remarketing option based on email address
                lists.
              </p>
              <p>
                In addition to any opt-out offered by any of the services below,
                the User may opt out of a third-party service&apos;s use
                of cookies for certain remarketing features by visiting
              ...
              <p>
                ...
                scripts needed on this Website in a centralized fashion. This
              ...
              <ul>
                <li>
                  ...
                  withdraw consent where they have previously given their
                ...
                <li>
                  ...
                  under certain circumstances, to restrict the processing of
                  their Data. In this case, the Owner will not process their
              ...
              <p>
                ...
                purposes described. Some of the purposes for which Cookies are
              ...
              <p>
                This Website uses Cookies to save the User&apos;s session and to
                carry out other activities that are strictly necessary for the
                operation of this Website, for example in relation to the
              ...
              <p>
                This Website uses Cookies to save browsing preferences and to
                optimize the User&apos;s browsing experience. Among these
                Cookies are, for example, those used for the setting of language
                and currency preferences or for the management of first party
              ...
              <p>
                Personal Data collected: Cookies and unique device identifiers
              ...
              <p>
                This type of service allows this Website and its partners to
                inform, optimize and serve advertising based on past use of this
                Website by the User. This activity is performed by tracking
                Usage Data and by using Cookies, information that is transferred
                to the partners that manage the remarketing and behavioral
                targeting activity. Some services offer a remarketing option
                based on email address lists. In addition to any opt-out offered
                by any of the services below, the User may opt out of a
                third-party service&apos;s use of cookies for certain
                remarketing features by visiting the Network Advertising
              ...
              <p>
                ...
                possible to delete Cookies installed in the past, including the
                Cookies that may have saved the initial consent for the
                installation of Cookies by this website. Users can, for example,
                find information about how to manage Cookies in the most
                commonly used browsers at the following addresses: Google
                Chrome, Mozilla Firefox, Apple Safari and Microsoft Internet
                Explorer.
              </p>
              <p>
              ...
              <p>
                Notwithstanding the above, the Owner informs that Users may
                follow the instructions provided on the subsequently linked
                initiatives by the EDAA (EU), the Network Advertising
                Initiative (US) and the Digital Advertising
              ...
              <h4>Additional information about User&APOS;s Personal Data</h4>
              <p>
              ...
              <p>
                ...
                with this Website (System logs) use other Personal Data (such as
              ...
              <p>
                this Website does not support “Do Not Track” requests. To
              ...
              <p>
                ...
                and possibly within this Website and/or - as far as technically
              ...
              <p>
                ...
                status of the server&APOS;s answer (successful outcome, error,
                ...
                and/or the User&APOS;s IT environment.
              </p>
              <h4>User</h4>
              <p>
              ...
              <h4>Cookies</h4>
              <p>Small sets of data stored in the User&APOS;s device.</p>
